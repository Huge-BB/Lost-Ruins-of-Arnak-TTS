...
import { applyResearchManualData, assertVerifiedResearchBridge, findResearchBridge } from './research-manual.ts';
...
const track: ResearchTrackDefinition = {
  ...
  name: 'Bird',
  rows: [
    { magnifyingPoints: 1, journalPoints: 0, grantsAssistant: false, nodes: [{ id: 'bird:r0:p0', pathIndex: 0 }] },
    { magnifyingPoints: 2, journalPoints: 1, grantsAssistant: false, nodes: [{ id: 'bird:r1:p0', pathIndex: 0 }] },
  ],
  bridges: [
